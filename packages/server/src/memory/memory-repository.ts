...
export class MemoryRepository {
  ...
  /**
   * Clear all search caches (public method for force-refresh)
   * Use this when you need to ensure fresh results from the database
   */
  clearSearchCache(): void {
    this.invalidateSearchCache();
    Logger.debug("Search cache cleared manually");
  }
