/**
 * MemoryGraph3DEnhanced Component
 *
 * An enhanced 3D force-directed graph visualization for memory nodes using react-force-graph-3d.
...
export interface MemoryGraph3DEnhancedProps {
...
export function MemoryGraph3DEnhanced({
  nodes,
  edges,
  selectedNodeId = null,
  onNodeClick,
  ...
  onBackgroundClick,
}: MemoryGraph3DEnhancedProps): React.ReactElement {
...
export default MemoryGraph3DEnhanced;
