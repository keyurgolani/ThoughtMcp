/**
 * MemoryGraph4 Route Page
 *
 * Reference route for graph style 4 comparison.
...
import { MemoryGraphStyle4 } from "./reference-graphs";
...
export function MemoryGraph4(): React.ReactElement {
