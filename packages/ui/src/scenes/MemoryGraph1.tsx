/**
 * MemoryGraph1 Route Page
 *
 * Reference route for graph style 1 comparison.
...
import { MemoryGraphStyle1 } from "./reference-graphs";
...
export function MemoryGraph1(): React.ReactElement {
