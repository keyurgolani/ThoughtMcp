/**
 * MemoryGraph5 Route Page
 *
 * Reference route for graph style 5 comparison.
...
import { MemoryGraphStyle5 } from "./reference-graphs";
...
export function MemoryGraph5(): React.ReactElement {
