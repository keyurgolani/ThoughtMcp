/**
 * MemoryGraph2 Route Page
 *
 * Reference route for graph style 2 comparison.
...
import { MemoryGraphStyle2 } from "./reference-graphs";
...
export function MemoryGraph2(): React.ReactElement {
