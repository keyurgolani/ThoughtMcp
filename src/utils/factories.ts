 ...
 */
export function createDefaultReasoningStep(
 ...
 */
export function createDefaultThoughtMetadata(
  overrides: Partial<ThoughtMetadata> = {}
): ThoughtMetadata {
  return {
 ...
 */
export function createDefaultThoughtResult(
  overrides: Partial<ThoughtResult> = {}
): ThoughtResult {
 ...
 */
export function createDefaultMemoryChunk(
  ...
  if (overrides.associations) {
    const mergedAssociations = new Set([
      ...defaultChunk.associations,
 ...
 */
export function createDefaultCognitiveConfig(
 ...
 */
export function createDefaultCognitiveInput(
  overrides: Partial<CognitiveInput> = {}
): CognitiveInput {
  return {
    ...
    reasoning_path: [
      {
        ...
        alternatives: [
          createDefaultAlternative({
            content: "Alternative pattern match",
            confidence: 0.7,
          }),
        ],
      },
      {
        ...
        alternatives: [
          createDefaultAlternative({
            content: "Alternative logical path",
            confidence: 0.6,
          }),
          createDefaultAlternative({
            content: "Another logical approach",
            confidence: 0.5,
          }),
        ],
      },
