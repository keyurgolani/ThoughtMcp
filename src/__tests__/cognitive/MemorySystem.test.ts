...
describe('MemorySystem', () => {
  ...
  describe('memory retrieval', () => {
    ...
    it('should retrieve memories from both systems', async () => {
      const result = await memorySystem.retrieveMemories('machine learning', 0.2);
    ...
    it('should compute combined relevance score', async () => {
      const aiResult = await memorySystem.retrieveMemories('neural networks', 0.2);
    ...
    it('should respect retrieval thresholds', async () => {
      const highThreshold = await memorySystem.retrieveMemories('learning', 0.8);
  ...
  describe('contextual retrieval', () => {
    ...
    it('should retrieve episodes by context', () => {
      ...
      const cookingEpisodes = memorySystem.getEpisodesByContext('domain', 'cooking');
  ...
  describe('error handling', () => {
    ...
    it('should handle invalid process operations', async () => {
      await expect(memorySystem.process({
        operation: 'invalid'
      })).rejects.toThrow();
    });
  ...
  describe('integration scenarios', () => {
    it('should handle complex learning scenario', async () => {
      ...
      const mlMemories = await memorySystem.retrieveMemories('machine learning', 0.3);
