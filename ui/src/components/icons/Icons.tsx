...
export function getSectorIcon(
  sector: MemorySectorType | string,
  size: IconSize = 'md'
): ReactElement {
  const props = { size };
  switch (sector) {
    case 'episodic':
      return <EpisodicIcon {...props} />;
    case 'semantic':
      return <SemanticIcon {...props} />;
    case 'procedural':
      return <ProceduralIcon {...props} />;
    case 'emotional':
      return <EmotionalIcon {...props} />;
    case 'reflective':
      return <ReflectiveIcon {...props} />;
    default:
      return <DefaultSectorIcon {...props} />;
  }
}
