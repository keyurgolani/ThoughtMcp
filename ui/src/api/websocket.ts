...
/**
 * ThoughtMCP WebSocket Client for real-time updates
 *
 * Requirements: 10.1-10.5
 */
export class ThoughtMCPWebSocket {
...
/**
 * Create a new ThoughtMCP WebSocket client
 */
export function createThoughtMCPWebSocket(config: WebSocketClientConfig): ThoughtMCPWebSocket {
  return new ThoughtMCPWebSocket(config);
}
...
let defaultWebSocket: ThoughtMCPWebSocket | null = null;

/**
 * Get or create the default WebSocket client
 */
export function getDefaultWebSocket(): ThoughtMCPWebSocket {
  if (defaultWebSocket === null) {
    ...
    defaultWebSocket = createThoughtMCPWebSocket({ url: wsUrl });
  }
 ...
 */
export function setDefaultWebSocket(client: ThoughtMCPWebSocket): void {
