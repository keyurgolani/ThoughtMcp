  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Primary glow variants (themed)
        glow: '0 0 20px var(--theme-primary-glow), 0 0 40px var(--theme-primary-bg)',
        'glow-sm': '0 0 10px var(--theme-primary-glow)',
        'glow-lg': '0 0 30px var(--theme-primary-glow), 0 0 60px var(--theme-primary-bg)',
        'glow-intense':
          '0 0 20px var(--theme-primary-glow), 0 0 40px var(--theme-primary-subtle), 0 0 60px var(--theme-primary-bg)',
        // Secondary glow variants (themed)
        'glow-secondary':
          '0 0 20px var(--theme-secondary-glow), 0 0 40px var(--theme-secondary-bg)',
        'glow-secondary-sm': '0 0 10px var(--theme-secondary-glow)',
        'glow-secondary-lg':
          '0 0 30px var(--theme-secondary-glow), 0 0 60px var(--theme-secondary-bg)',
        // Highlight glow variants (themed)
        'glow-highlight':
          '0 0 20px var(--theme-highlight-glow), 0 0 40px var(--theme-highlight-bg)',
        'glow-highlight-sm': '0 0 10px var(--theme-highlight-glow)',
        'glow-highlight-lg':
          '0 0 30px var(--theme-highlight-glow), 0 0 60px var(--theme-highlight-bg)',
        // Legacy glow variants (for backward compatibility)
        ...
        'glow-purple': '0 0 20px rgba(155, 89, 182, 0.3), 0 0 40px rgba(155, 89, 182, 0.15)',
        'glow-purple-sm': '0 0 10px rgba(155, 89, 182, 0.2)',
        'glow-purple-lg': '0 0 30px rgba(155, 89, 182, 0.4), 0 0 60px rgba(155, 89, 182, 0.2)',
        // Status glow variants
        'glow-success': '0 0 15px rgba(39, 174, 96, 0.3)',
        'glow-error': '0 0 15px rgba(231, 76, 60, 0.3)',
        'glow-warning': '0 0 15px rgba(243, 156, 18, 0.3)',
        // Inner glow for glassmorphism (themed)
        'inner-glow': 'inset 0 0 30px var(--theme-primary-bg)',
        'inner-glow-gold': 'inset 0 0 30px rgba(255, 215, 0, 0.05)',
        'inner-glow-purple': 'inset 0 0 30px rgba(155, 89, 182, 0.05)',
        // Combined panel shadows (themed)
        panel:
          '0 0 20px var(--theme-primary-glow), 0 0 40px var(--theme-primary-bg), inset 0 0 30px var(--theme-primary-bg)',
        'panel-elevated': '0 8px 32px rgba(0, 0, 0, 0.5), 0 0 20px var(--theme-primary-glow)',
        'panel-floating': '0 12px 48px rgba(0, 0, 0, 0.6), 0 0 30px var(--theme-primary-glow)',
      },
